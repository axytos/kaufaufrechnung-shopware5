...
class CancelOrderSubscriber implements EventSubscriber
{
    ...
    public function preUpdate(PreUpdateEventArgs $eventArgs): void
    {
        try {
            ...
            if ($newOrderStatus->getId() !== Status::ORDER_STATE_CANCELLED_REJECTED) {
                return;
            }
            ...
            $invoiceClient->cancelOrder($invoiceOrderContext);
        } catch (\Throwable $th) {
            /** @var ErrorHandler */
